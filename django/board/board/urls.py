...
urlpatterns = [
    ...
    # http://localhost:8000/board/question/modify/1 (질문번호)
    path(
        "question/create/modify/<int:qid>/",
        question_views.question_modify,
        name="question_modify",
    ),
    # http://localhost:8000/board/question/delete/1 (질문번호)
    path(
        "question/create/delete/<int:qid>/",
        question_views.question_delete,
        name="question_delete",
    ),
    # http://localhost:8000/board/answer/modify/1 (답변번호)
    path(
        "answer/create/modify/<int:aid>/",
        answer_views.answer_modify,
        name="answer_modify",
    ),
    # http://localhost:8000/board/answer/delete/1 (답변번호)
    path(
        "answer/create/delete/<int:aid>/",
    ...
    # http://localhost:8000/board/comment/modify/question/1 <comment id>
    path(
        "comment/modify/question/<int:cid>/",
        comment_views.comment_modify_question,
        name="comment_modify_question",
    ),
    # http://localhost:8000/board/comment/delete/question/1 <comment id>
    path(
    ...
    path(
        "comment/modifiy/answer/<int:cid>/",
    ...
    # http://localhost:8000/board/vote/answer/1 <question id> : 답변추천
